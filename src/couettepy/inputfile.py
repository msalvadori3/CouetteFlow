...
class read_input_file(object):
    ...
    def __init__(self,filename):
        ...
        setup_dt = setup.find('dt')
        setup_theta = setup.find('theta')

        self.dt = setup_dt.text
        self.theta=setup_theta.text
...
def usage():
    ...
    parser.add_option("-e", "--exe", dest="CouetteFlw", default=None,
